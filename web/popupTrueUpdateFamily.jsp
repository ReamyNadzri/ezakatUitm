    ...
    <body onload="showpopup()"> <!-- Automatically show popup on page load -->  
        ...
        <div id="popupModal" class="modal-overlay">  
            <div class="modal-box">  
                ...
                <!-- Warning Text -->  
                <div class="modal-text">Family Profile successfully updated!</div>  

                <!-- Back Button -->  
               <button type="button" class="back" onclick="window.location.href='studentDashboard.jsp';">Kembali</button>
            </div>  
        </div>  
