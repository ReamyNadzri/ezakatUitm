...
<body>
    ...
    <button id="openLoginModal">Login as Student</button>

    <!-- Login Modal -->
    <div id="loginModal" class="modal">
        <div class="modal-content">
            <h2 style="text-align:center;">Login Pelajar</h2>
            <!-- Login Form -->
            <form action="login.jsp" method="post">
                <input type="text" name="matric_number" placeholder="Nombor Matrik..." required>
                ...
                <div class="register-link">
                    Anda Belum Mendaftar? <a href="studentForm.jsp" id="openRegisterForm">Daftar Sekarang</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        openRegisterFormLink.onclick = function () {
            ...
            setTimeout(() => {
                ...
                window.location.href = "studentForm.jsp"; // Redirect to register form (use JSP page)
            }, 300);
        };
    </script>
</body>
