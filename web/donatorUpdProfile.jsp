...
<body class="w3-light-grey">  
    <div class="w3-content w3-padding-32 w3-margin-top w3-margin-bottom w3-round-large w3-white w3-card-4" style="max-width: 800px;">  
        ...
        %>
                        <!-- Add this form to your existing JSP page -->
                        <div class="w3-margin-top">  
                            <form action="donatorUpdServlet" method="post" class="w3-container">
                                ...
                                <div class="w3-margin-top w3-center">
                                    ...
                                    <button type="submit" class="w3-button w3-green w3-round-large">Simpan !</button>
                                </div>
                            </form>
                        </div>
        <%  
