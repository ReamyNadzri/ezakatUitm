...
<body>
    ...
    <div class="w3-container w3-row">
        ...
        <div class="w3-container w3-col" style="width: 80%; height: auto">
            ...
            <div class="w3-container w3-col w3-center w3-border" style="padding-left: 10%; padding-right: 10%; padding-top:20px; height:42% ;">
                <h3 class="w3-center">Kategori Pemilihan Zakat</h3> 

               
                <div class="w3-container w3-cell w3-border w3-round-large w3-white w3-card w3-hover-light-grey" style="height: auto; width: 24%;">
                    <a href="mohonzakat.jsp"><img src="sources/accord1994.jpg" alt="" style="padding:10px; width: 100%;">
                        <p>Zakat Kolej</p> </a>
                </div>
                ...
                <div class="w3-cell" style="width:10px"></div>
                <div class="w3-container w3-cell w3-border w3-round-large w3-white w3-card w3-hover-light-grey" style="height: auto; width: 24%;">
                    <a href="mohonzakat.jsp"><img src="sources/accord1994.jpg" alt="" style="padding:10px; max-width: 100%;">
                    <p>Zakat Makan</p>  </a>
                </div>
