            ...
            <tbody>  
                <%  
                    ...
                    try {  
                        ...
                        rs = stmt.executeQuery("SELECT ADMINID, USERNAME, PHONENUM FROM ADMIN ORDER BY ADMINID DESC");  
                        int count = 1;  
                        while (rs.next()) {  
                %>  
                <tr>  
                ...
                <%  
                        ...
                        out.println("<tr><td colspan='4' class='border px-4 py-2 text-center text-red-600'>SQL Error: " + e.getMessage() + "</td></tr>");  
                    } catch (Exception e) {  
                        out.println("<tr><td colspan='4' class='border px-4 py-2 text-center text-red-600'>Error: " + e.getMessage() + "</td></tr>");  
                    } finally {  
                        // Close resources  
