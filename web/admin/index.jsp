...
<div class="w3-container w3-center w3-middle">
  ...
  <h2>WARNING!</h2>
  <h4>Now you in admin zakat uitmct site.</h4>
    ...
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <div class="w3-center"><br>
        ...
        <form class="w3-container w3-center w3-round-large" action="loginAdminStaff" method="POST"><br>
            <b>Admin ID</b> <input type="text" name="staffNo" placeholder="Masukkan Nombor Pekerja" required><br><br>

            <b>Password</b> <input type="password" name="staffPass"  placeholder="Masukkan Password Anda" required><br><br>
