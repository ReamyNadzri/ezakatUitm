...
<body>
    ...
    <button id="openLoginModal">Login as Staf</button>

    <!-- Login Modal -->
    <div id="loginModal" class="modal">
        <div class="modal-content">
            <h2 style="text-align:center;">Login Staf</h2>
            <!-- Login Form -->
            <form action="loginStaff.jsp" method="post">
                <input type="text" name="staff_number" placeholder="Nombor Staf..." required>
                ...
                <div class="register-link">
                    Anda Belum Mendaftar? <a href="registerStaff.jsp" id="openRegisterForm">Daftar Sekarang</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        openRegisterFormLink.onclick = function () {
            ...
            setTimeout(() => {
                ...
                window.location.href = "registerStaff.jsp"; // Redirect to register form (use JSP page)
            }, 300);
        };
    </script>
</body>
