...
public class successLoginStudent extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.getWriter().println("<p style='text-align: center;'>Matric Number: " + matricNumber + "</p>");
        response.getWriter().println("<div style='text-align: center;'>");
        response.getWriter().println("<a href='studentDashboard.jsp' style='text-decoration: none; color: white; background-color: purple; padding: 10px 20px; border-radius: 4px;'>Go to Dashboard</a>");
