...
@WebServlet("/successLoginStaff")
public class successLoginStaff extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.getWriter().println("<h1 style='color: green; text-align: center;'>Welcome, Staff!</h1>");
        response.getWriter().println("<h3 style='text-align: center;'>You have successfully logged in.</h3>");
        response.getWriter().println("<p style='text-align: center;'>Staff Number: " + staffNo + "</p>");
